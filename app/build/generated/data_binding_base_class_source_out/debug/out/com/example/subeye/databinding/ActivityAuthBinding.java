...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  @NonNull
  public final Button githubLoginBtn;
  ...
  @NonNull
  public final Button urgentCall;
  ...
  private ActivityAuthBinding(@NonNull ScrollView rootView, @NonNull EditText authEmailEditView,
      ...
      @NonNull Button githubLoginBtn, @NonNull Button goSignInBtn, @NonNull Button googleLoginBtn,
      @NonNull Button loginBtn, @NonNull Button logoutBtn, @NonNull Button signBtn,
      @NonNull Button urgentCall) {
    ...
    this.githubLoginBtn = githubLoginBtn;
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.githubLoginBtn;
      Button githubLoginBtn = ViewBindings.findChildViewById(rootView, id);
      if (githubLoginBtn == null) {
        break missingId;
      }
      ...
      id = R.id.urgentCall;
      Button urgentCall = ViewBindings.findChildViewById(rootView, id);
      if (urgentCall == null) {
        break missingId;
      }

      return new ActivityAuthBinding((ScrollView) rootView, authEmailEditView, authMainTextView,
          authPasswordEditView, githubLoginBtn, goSignInBtn, googleLoginBtn, loginBtn, logoutBtn,
          signBtn, urgentCall);
    }
